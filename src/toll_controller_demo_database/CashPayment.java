...
Date date=new Date();
   ...
   // String[] drop = {"Bkash", "Nogod", "Rocket"};
    ...
    public CashPayment() {
        ...
        c1.setBackground(new Color(136, 196, 245));
        c1.setLayout(null);
...
//
    //background image
        ImageIcon backgroundImage = new ImageIcon("IMAGES/cash_payment_background.png"); 
        ...
        //next.setBackground(new Color(1, 55, 125));
        next.setMnemonic('n');
        next.setFont(f2);
        ...
        //clear.setBackground(new Color(1, 55, 125));
        clear.setFont(f);
       ...
       // exitButton.setBackground(new Color(1, 55, 125));
       ...
       ImageIcon color_background = new ImageIcon("IMAGES/color.png");
        colorButton = new JButton("<COLOR>",color_background);
        colorButton.setBounds(900,0,90,30);
        //colorButton.setBackground(new Color(1, 55, 125));
        c1.add(colorButton);
...
//
        ...
        motorCycle.setBackground(new Color(1, 55, 125));
        ...
        car_jeep.setBackground(new Color(1, 55, 125));
        ...
        Pickup.setBackground(new Color(1, 55, 125));
        Pickup.setFont(f);
        ...
        microBus.setBackground(new Color(1, 55, 125));
        ...
        mediumBus.setBackground(new Color(1, 55, 125));
        ...
        bigBus.setBackground(new Color(1, 55, 125));
        bigBus.setFont(f);
        ...
        Truck_upto_5_tonnes.setBackground(new Color(1, 55, 125));
        ...
        Truck_5_8_tonnes.setBackground(new Color(1, 55, 125));
        ...
        Truck_3_axle.setBackground(new Color(1, 55, 125));
        ...
        Trailer_4_axle.setBackground(new Color(1, 55, 125));
        ...
        Tailer_above_4_axle.setBackground(new Color(1, 55, 125));
...
//
            ...
            else if(pay.equals(bills) || IntPay>bill){
              //  JOptionPane.showMessageDialog(null,"Driver will get refund :"+(IntPay-bill)+"TK","ALERT", JOptionPane.PLAIN_MESSAGE);
              //  JOptionPane.showMessageDialog(null,"---->CLEAR<-----","RIGHT",-1);
                String message = "Driver Pay "+IntPay+" tk"
                        + "\nDriver will get refund :"+(IntPay-bill)+"tk "
                        +"\n          Thank You!"
                        + "\n---------->CLEAR<---------";
               JOptionPane.showMessageDialog(null, message, "Right", JOptionPane.PLAIN_MESSAGE);              
...
int i=10;
                    ...
                    try{
                        Conn conn=new Conn();
                        String query="insert into collected_toll_record values('"+vehicleName+" ', ' "+LicenseNumber+" ', ' Cash ', ' "+bill+" ','"+date+"')";
                ...
                String message = "Your Bill is: "+bill+" tk"
                               + "\nYou Enter :"+IntPay+"tk "
                               + "\nYou have entered "+ (bill-IntPay)+ " taka less than the bill. "
                               + "\nFor successful completion,\n"
                               + "the input needs to be "+bill+" tk.";
               // JOptionPane.showMessageDialog(null,"OPS...!YOUR BILL :"+bill+"TK YOU ENTER","ALERT",JOptionPane.ERROR_MESSAGE);
